...
function checkCard(){
    ...
    if(cardsChosenIds[0] === cardsChosenIds[1]){
        document.getElementsByClassName('won')[0].innerHTML ='You have chosen the same card'
        cards[cardsChosenIds[0]].setAttribute('src','src/images/blank.png')
        cards[cardsChosenIds[1]].setAttribute('src','src/images/blank.png')
        document.querySelector('.header').innerHTML = ' Your score:'+ cardsWon.length
    }
    else if(cardsChosen[0] === cardsChosen[1]){
        document.getElementsByClassName('won')[0].innerHTML ='You Have Found a Match'
    ...
    document.querySelector('.header').innerHTML = 'Congratulation You Have Won The Game!!'
    document.getElementsByClassName('won')[0].innerHTML =''
    document.getElementsByClassName('loose')[0].innerHTML ='';
    }
